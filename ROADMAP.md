...
- [ ] Run 4 to 6 weeks with at least 6 plants.
- [ ] Use randomized block scheduling across host, repeated non-host, novel stranger, object-touch, and no-touch sessions.
- [ ] Confirm that raw signals can be aligned to event markers.
- [ ] Estimate variance components for plant, person, day, pressure, and ambient environment.
- [ ] Revise power analysis from observed pilot variance.

## Phase 3: Confirmatory Study

- [ ] Preregister final hypotheses and exclusions.
- [ ] Run multi-plant cohort for 6 months.
- [ ] Lock analysis code before unblinding condition labels.
- [ ] Report null, mixed, and positive outcomes with equal clarity.

## Phase 4: Replication

- [ ] Repeat in 3 independent runs with different plant individuals.
