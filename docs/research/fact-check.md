...
| Plant cells can distinguish touch onset from touch release. | Supported in specific experimental systems | Useful for designing event markers around touch start and stop. Do not generalize to human recognition. | [PubMed: pavement cells distinguish touch from letting go](https://pubmed.ncbi.nlm.nih.gov/37188852/), [WSU summary](https://news.wsu.edu/press-release/2023/05/31/plants-can-distinguish-when-touch-starts-stops/) |
